...
<%@page import="java.sql.*" %>
          ...
          <%
             String codeword=request.getParameter("codeword"); 
              ...
              ResultSet rs=st.executeQuery("select * from products where codeword='"+codeword+"' ");
              %>
           ...
           <h2> View Searched Product Details</h2>
            ...
            <table align="center"border="2px" >
                ...
                <%while(rs.next())
                            ...
                            <td><a href="PPurchase.jsp?pid=<%=rs.getString(6)%>&value=codewise&pname=<%=codeword%>"><input type="button" value="PURCHASE"></a></td> 
                        <% }
}
catch(Exception e)
{
